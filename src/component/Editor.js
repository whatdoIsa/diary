...
//Editor 컴포넌트 - 날짜, 감정이미지, 일기텍스트 입력
//Editor 컴포넌트에서 getFormattedDate 호출 state.date 초기값을 오늘로 지정
const Editor = ({ initData, onSubmit}) => {
    const navigate = useNavigate(); //페이지 이동을 구현한 함수
    ...
    const [state, setState] = useState({
        //state 초기값 설정 위해 useState의 인수로 받음
    ...
    //일기를 작성한 글상자 이벤트 핸들러, 작성한 일기 데이터는 state.content 프로퍼티로 저장
